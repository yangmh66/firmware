...
enum {
	FINISHED_GENERATING_START_CONDITION,
	FINISHED_SENDING_DEVICE_ADDRESS,
	FINISHED_SENDING_WORD_ADDRESS,
	FINISHED_GENERATING_START_CONDITION_AGAIN,
	FINISHED_SENDING_DEVICE_ADDRESS_AGAIN,
	READY_TO_RECEIVE_ONE_BYTE_DATA,
	READY_TO_RECEIVE_N_BYTE_DATA,
	FINISHED_GENERATING_STOP_CONDITION
} EEPROM_I2C_Event;
